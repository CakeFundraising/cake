class Fundraiser::DashboardController < ApplicationController
  ...
  def billing
    ...
    @campaigns_with_outstanding_invoices = current_fundraiser.campaigns.with_outstanding_invoices
    @campaigns_with_past_invoices = current_fundraiser.campaigns.with_paid_invoices
  end
