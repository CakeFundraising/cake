class CakesterEmailSettingsController < InheritedResources::Base
  ...
  def update
    update! do |success, failure|
      success.html do
        redirect_to edit_cakester_email_settings_path, notice: 'Email Settings successfully saved.'
      end
    end
  end

  def permitted_params
    params.permit(cakester_email_setting: 
