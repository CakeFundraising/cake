class CampaignsController < InheritedResources::Base
  ...
  def create
    ...
    create! do |success, failure|
      success.html do
        @campaign.update_screenshot(campaign_url(@campaign)) #update screenshot
  ...
  def update
    update! do |success, failure|
      success.html do
        resource.update_screenshot(campaign_url(resource)) #update screenshot
  ...
  def permitted_params
    ...
    :headline, :step, :main_cause, :visible, causes: [], scopes: [], video_attributes: [:id, :url],
    picture_attributes: [
