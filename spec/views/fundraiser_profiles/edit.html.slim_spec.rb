...
describe "fundraiser_profiles/edit" do
  before(:each) do
  ...
  it "renders the edit fundraiser_profile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", fundraiser_profile_path(@fundraiser_profile), "post" do
