...
describe "fundraisers/new" do
  before(:each) do
    assign(:fundraiser, stub_model(Fundraiser,
      :banner => "MyString",
      :avatar => "MyString",
      :cause => "MyString",
      :min_pledge => 1,
  ...
  it "renders new fundraiser form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", fundraisers_path, "post" do
